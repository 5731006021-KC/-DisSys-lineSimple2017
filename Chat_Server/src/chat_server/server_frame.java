...
public class server_frame extends javax.swing.JFrame 
{
     ...
     public void tellchangeport(String message) {
        ...
        while (it.hasNext()) {
            try { //Chiran Bawornkitiwong 5731018521
                ...
                ta_chat.append("Error sending message \n");
            }
        }
    }
                ...
                while ((message = reader.readLine()) != null) 
                {
                 ...
                 //   tellReceive2("Received: " + message + "\n");  
                    ...
                    else if (data[2].equals(chat)) 
                    {
                        ...
                        sendInvite(groupID, data[0], data[4]);                   
                        groups.add(groupID);
                    }
                    else 
                    {
  ...
  /*  public void connectToServer2() {
        try {
            ...
            ta_chat.append("Cannot connect to Bserver");
        }
    }*/
    
   
    
   /* public void tellReceive2(String message) {
        writerB.println(message);
        writerB.flush();
    }*/
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(b_start, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
    ...
    private void b_endActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_endActionPerformed
        try 
        {
          //   tellReceive2("ServerDown:"+users.size());
         //   writerB.flush();
    ...
    public void userAdd (String data) 
    {
      ...
      //  tellReceive2(users + "has connected"+"\n");
	...
	Iterator it = clientOutputStreams.iterator();
        ...
        while (it.hasNext()) 
        {
            try 
            {
             ...
             //   tellReceive2(cid1+":"+"Chat"+":"+message+":"+cid2 + ":" + (df.format(calobj.getTime())).substring(8));
                writer.flush();
                ta_chat.setCaretPosition(ta_chat.getDocument().getLength());
